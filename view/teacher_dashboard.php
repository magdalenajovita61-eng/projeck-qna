 <?php
// Removed session_start() to avoid duplicate session start warnings since header.php already starts the session
...
<div class="container">
    ...
    <table border="1" cellpadding="8" cellspacing="0" style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            <?php if(empty($users)): ?>
            <tr>
                <td colspan="5">No users found in your school.</td>
            </tr>
            <?php else: ?>
